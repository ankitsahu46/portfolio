import { Intro, ImageBox } from "./";

function Home() {
  return (
    <>
      <section id='home' className="lg:mx-20 md:mx-14 sm:mx-8  mb-28">
        ...
        <div className='text-white flex flex-col-reverse md:flex-row w-full pt-5 md:pt-16'>
          <Intro />
          <ImageBox />
        </div>
      </section>
