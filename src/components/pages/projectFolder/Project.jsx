...
function Project(props) {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-center items-center mt-16 font-medium [&>*]:flex-1 px-10">
      <div className="w-4/5 h-auto flex justify-center items-center hover:scale-[0.98] transition-all relative  ">
        <img src={img} alt="project image" className="rounded-lg" />
      
        <div className="two absolute bg-transparent w-full h-full">
          <div className="absolute w-[75px] h-8 right-2 top-2 border-[1px] border-gray-400  bg-white rounded-full cursor-pointer shadow-lg">
            <a href={code} target='_black'>
              <img src="src/assets/gitHub.svg" alt="GitHub" className="bg-transparent p-1 -top-[1px] absolute " />
            </a>
